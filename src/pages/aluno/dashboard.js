                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      ...
                      {calcularVariacao('percentualGordura') !== null && (
                        <span className={`ml-2 text-sm ${parseFloat(calcularVariacao('percentualGordura')) < 0 ? 'text-green-600' : 'text-blue-600'}`}>
                    ...
                    <p className="text-gray-600 mb-2">
                      ...
                      {calcularVariacao('massaMagra') !== null && (
                        <span className={`ml-2 text-sm ${parseFloat(calcularVariacao('massaMagra')) > 0 ? 'text-green-600' : 'text-blue-600'}`}>
