          ...
          <div className="mt-3 text-center">
            ...
            <div className="items-center px-4 py-3 flex gap-3 justify-center">
              ...
              <button
                ...
                disabled={excluindo}
                className="px-4 py-2 bg-blue-600 text-white text-base font-medium rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:opacity-50"
              >
